...
<center><font size = "8" color="white"><b>Teacher Data</b></font><br></center>
<br>
<form action="getteacher.php" method="post">
<center>
<label><font size = "5" color="white" >Enter Teacher ID:</font></label><br>
...
$sql = "SELECT * FROM teacher WHERE id = '$myid1'";
$result = $db->query($sql);
echo "<br>";
